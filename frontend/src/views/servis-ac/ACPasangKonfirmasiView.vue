...
const kartuLokasi = ref<InstanceType<typeof KartuLokasiPeta> | null>(null)

/*
 * Peta dilepas begitu permintaan terkirim: formulirnya diganti layar konfirmasi
 * lewat v-if, jadi wadah petanya hilang dari DOM — dan Leaflet yang masih
 * memegang elemen mati itu ribut saat halaman diubah ukurannya. Yang melepas
 * kartunya sendiri, lewat metode yang ia bukakan.
 */
watch(hasil, (terkirim) => {
  if (terkirim) kartuLokasi.value?.lepasPeta()
})
