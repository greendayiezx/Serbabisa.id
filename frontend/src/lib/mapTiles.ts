 ...
 */
export function pinIcon(color = '#1e9bf0'): L.DivIcon {
  return L.divIcon({
    className: '',
    html:
      `<svg viewBox="0 0 24 24" width="40" height="40" stroke="${color}" stroke-width="2" fill="rgba(255,255,255,0.95)" stroke-linecap="round" stroke-linejoin="round" style="filter: drop-shadow(0 4px 10px rgba(0,0,0,0.2))">` +
