 ...
 *    naik ke pita paling atas, sementara batas bawahnya dipangkas ke 320 dan
 *    seluruh blok di bawah judul dinaikkan 60. Memangkas tanpa menaikkan
 *    hanya memotong label podium dan badge. Di mode itu judulnya rata KANAN — pojok kiri
...
<template>
  <div class="ac-hero" :class="{ 'ac-hero--penuh': penuh }">
    <svg
      class="ac-hero__svg"
      :viewBox="penuh ? '0 -80 750 400' : '0 0 750 400'"
      width="100%"
      role="img"
    ...
    >
      ...
      <!--
        Semua yang di bawah judul naik 60 satuan lewat SATU pembungkus, supaya
        bingkai bisa dipangkas tanpa memotong label podium dan badge.

        Lewat pembungkus, bukan transform pada tiap grup: podium tengah, ikon
        alat, teknisi, dan percikan semuanya dianimasikan dengan transform, dan
        transform dari CSS menimpa transform dari atribut.
      -->
      <g :transform="penuh ? 'translate(0 -60)' : ''">
      ...
      <!--
        Judul TIDAK ikut naik: ia duduk di pita paling atas, jadi pembungkus
        kenaikan berhenti di sini dan dibuka lagi setelahnya.
      -->
      <!-- ================= 03. HEADLINE AREA ================= -->
      <g class="layer-text">
        <!-- Headline -->
        ...
        -->
        <!--
          Turun 37, bukan 120: bingkai dipangkas 80 satuan dan seluruh blok
          ilustrasi naik 60, jadi dasar badge harus ikut naik. Pada 120
          lingkarannya berakhir di y=393, jauh di bawah tepi baru (320).
          Angka ini menyejajarkannya dengan dasar label podium.
        -->
